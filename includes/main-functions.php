...
function text_ajax_process_request() {
       ...
       // echo $_POST["page_state"];
        ...
        for ($i=0; $i < $per_page; $i++) {
            ...
            if ($media_type == "phone") {
                ...
                $fancy = "fancybox fancybox.iframe";
            }
            ...
            <a title=\"$bandName\" class=\"image $fancy\" href=\"$video_url\" onclick=\"setURL('$pageURL');increment('$videoType','$id');\">
            <span class=\"roll\"></span>
            <img width=\"150\" height=\"100\" src=\"$thumbnail\">
            </a></div>
            <div class=\"media-info\">
            <a class=\"media-link tile_link $fancy\" title=\"$bandName\" href=\"$video_url\" onclick=\"setURL('$pageURL');increment('$videoType','$id');\">$bandName, $videoType</a>
            </div>
    ...
    if ($_POST["post_var"] == "newest") {
        ...
        for ($i=0; $i < $per_page; $i++) {
            ...
            <script type="text/javascript" charset="utf-8">
            (function($) {
            $("#driver_newest").css('visibility','hidden')
            })(jQuery);
            </script>            
            <?php
            } else {
            ...
            <script type="text/javascript" charset="utf-8">
            (function($) {
            $("#driver_newest").css('visibility','visible')
            })(jQuery);
            </script>
            <?php
            }
    ...
    if ($_POST["post_var"] == "concerts") {
        ...
        for ($i=0; $i < $per_page; $i++) {
            ...
            <script type="text/javascript" charset="utf-8">
            (function($) {
            $("#driver_concerts").css('visibility','hidden')
            })(jQuery);
            </script>            
            <?php
            } else {
            ...
            <script type="text/javascript" charset="utf-8">
            (function($) {
            $("#driver_concerts").css('visibility','visible')
            })(jQuery);
            </script>
             <?php
            }
    ...
    if ($_POST["post_var"] == "sessions") {
	    ...
	    if ($m + 1 == $total ) {
            ...
            <script type="text/javascript" charset="utf-8">
            (function($) {
            $("#driver_sessions").css('visibility','hidden')
            })(jQuery);
            </script>            
            <?php
            } else {
            ...
            <script type="text/javascript" charset="utf-8">
            (function($) {
            $("#driver_sessions").css('visibility','visible')
            })(jQuery);
            </script>
            <?php
            }
    ...
    if ($_POST["post_var"] == "interviews") {
	    ...
	    if ($m + 1 == $total ) {
            ...
            <script type="text/javascript" charset="utf-8">
            (function($) {
            $("#driver_interviews").css('visibility','hidden')
            })(jQuery);
            </script>            
            <?php
            } else {
            ...
            <script type="text/javascript" charset="utf-8">
            (function($) {
            $("#driver_interviews").css('visibility','visible')
            })(jQuery);
            </script>
             <?php
            }            
    ...
    if ($_POST["post_var"] == "music") {
	    ...
	    if ($m + 1 == $total ) {
            ...
            <script type="text/javascript" charset="utf-8">
            (function($) {
            $("#driver_music").css('visibility','hidden')
            })(jQuery);
            </script>            
            <?php
            } else {
            ...
            <script type="text/javascript" charset="utf-8">
            (function($) {
            $("#driver_music").css('visibility','visible')
            })(jQuery);
            </script>
             <?php
            }
...
function display_link($content) {
    ...
    if (is_single()) {
        ...
        // put the blue box here for appending
        
        echo '<div class="body_content_box">';
